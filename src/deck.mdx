...
- configure how Relay will fetch query/mutation operations
- configure how Relay will handle subscriptions

---

## Relay Network Layer - fetchQuery

- handle authentation on fetch Headers
...
- consume query data that has already started based on location change or event
...
- same as useFragment (declare component data dependencies)
- handle pagination refetch patterns
